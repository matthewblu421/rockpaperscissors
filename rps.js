...
document
  ...
  .addEventListener("click", () => playRound("Rock", computerPlay()));
document
  .getElementById("button2")
  .addEventListener("click", () => playRound("Paper", computerPlay()));
document
  .getElementById("button3")
  .addEventListener("click", () => playRound("Scissors", computerPlay()));
